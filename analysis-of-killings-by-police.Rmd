...
# Reflection
Choosing appropriate plots seems to be the hardest. It helps to breaks the values down and know what's discrete, what's continuous, how many variables one plans to include in a plot, and finally what the overall effect should be. This data set dealt with a larger amount of discrete variables; knowing what works well for more variables requiring continuous analysis should be considered for future projects.

Knowing how best to work with bivariate plots, specifically correlations, is another point of improvement needed for future analyses.
